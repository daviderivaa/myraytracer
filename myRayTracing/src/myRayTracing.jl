...
export Vec, Point, Normal, Transformation, print_element, add_xyz, sub_xyz, scalar_multip, neg, dot, squared_norm, norm, normalize, Vec_to_Normal_and_v, cross, Point_to_Vec, is_consistent
