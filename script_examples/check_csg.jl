...
c1 = Cylinder(0.35, 1.05, translation(Vec(-0.5, 0.0, 0.5))(rotation("y", π/2)), material2)
c2 = Cylinder(0.35, 1.05, translation(Vec(0.0, 0.0, -0.0)), material2)
c3 = Cylinder(0.35, 1.05, rotation("z", π/2)(translation(Vec(-0.5, 0.0, 0.0))(rotation("y", π/2))), material2)
